...
You can see a [worked example](https://github.com/approov/quickstart-watchos-swift-urlsession/blob/master/SHAPES-EXAMPLE.md#shapes-app-with-secrets-protection) for the Shapes app.
